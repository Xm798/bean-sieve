...
def test_check_scope_filters_out_accounts_not_in_scope(tmp_path):
    ...
    Accounts like Assets:Bank:ICBC:9999 already encode the card number in the
    ...
    ledger = _write_ledger(
        ...
        """
2025-03-15 * "某商户" "消费"
    Assets:Bank:ICBC:9999  -28.00 CNY
    Expenses:FIXME  28.00 CNY

1900-01-01 open Assets:Bank:ICBC:9999
...
2025-03-16 * "B" "b"
    Assets:Bank:ICBC:9999  -10.00 CNY
