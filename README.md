...
2025-03-15 ! "瑞幸咖啡" "拿铁"
  ...
  Liabilities:Credit:HXB  -28.00 CNY
    card_last4: "1234"             ; posting 级，标识具体是哪张卡
...
**诊断作用域**：只对"账户名本身无法识别具体卡"的账户生效——即自动识别的共享账户（多 pattern → 单 account，如 `Liabilities:Credit:HXB`）。账户名已带卡号的（如 `Assets:Bank:ICBC:9999`、`Liabilities:Credit:BOCOM:U-东航金0001`）不会产生诊断。
